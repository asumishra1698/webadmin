...
const QuickSettings: React.FC<QuickSettingsProps> = ({
  ...
  <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 shadow-sm border border-gray-100 dark:border-gray-700">
    ...
    <div className="mb-4 sm:mb-6">
      ...
      <div className="flex items-center justify-between p-2 sm:p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
        <div className="flex items-center">
          <Clock className="w-4 h-4 sm:w-5 sm:h-5 text-gray-600 dark:text-gray-300 mr-2 sm:mr-3" />
    ...
    <div className="mb-4 sm:mb-6">
      ...
      <div className="flex items-center justify-between p-2 sm:p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
        <div className="flex items-center">
          <Settings className="w-4 h-4 sm:w-5 sm:h-5 text-gray-600 dark:text-gray-300 mr-2 sm:mr-3" />
          <span className="text-xs sm:text-sm font-medium text-gray-900 dark:text-gray-100">
            12 Sites Configured
          </span>
        </div>
    ...
    <div>
      ...
      <div className="space-y-2 sm:space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <Mail className="w-3 h-3 sm:w-4 sm:h-4 text-gray-600 dark:text-gray-300 mr-2 sm:mr-3" />
          ...
          <button
            ...
            className={`w-9 h-5 sm:w-11 sm:h-6 rounded-full relative transition-colors duration-200 ${
              emailReportEnabled ? "bg-green-500" : "bg-gray-200 dark:bg-gray-700"
            }`}
          >
            <div
              className={`w-3 h-3 sm:w-4 sm:h-4 bg-white dark:bg-gray-900 rounded-full absolute top-1 transition-transform duration-200 ${
                emailReportEnabled
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <Bell className="w-3 h-3 sm:w-4 sm:h-4 text-gray-600 dark:text-gray-300 mr-2 sm:mr-3" />
            <span className="text-xs sm:text-sm text-gray-900 dark:text-gray-100">
              Tag Expiry Alerts
            </span>
          </div>
          <button
            ...
            className={`w-9 h-5 sm:w-11 sm:h-6 rounded-full relative transition-colors duration-200 ${
              expiryAlertsEnabled ? "bg-green-500" : "bg-gray-200 dark:bg-gray-700"
            }`}
          >
            <div
              className={`w-3 h-3 sm:w-4 sm:h-4 bg-white dark:bg-gray-900 rounded-full absolute top-1 transition-transform duration-200 ${
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <Smartphone className="w-3 h-3 sm:w-4 sm:h-4 text-gray-600 dark:text-gray-300 mr-2 sm:mr-3" />
            <span className="text-xs sm:text-sm text-gray-900 dark:text-gray-100">
          ...
          <button
            ...
            className={`w-9 h-5 sm:w-11 sm:h-6 rounded-full relative transition-colors duration-200 ${
              mobileNotificationsEnabled ? "bg-green-500" : "bg-gray-200 dark:bg-gray-700"
            }`}
          >
            <div
              className={`w-3 h-3 sm:w-4 sm:h-4 bg-white dark:bg-gray-900 rounded-full absolute top-1 transition-transform duration-200 ${
