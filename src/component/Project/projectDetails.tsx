    ...
    const assignedBrokers = Array.isArray(brokers)
        ? brokers.map((b: any, idx: number) => ({
            ...
            address: b.office_address
                ? `${b.office_address.line1 || ""}, ${b.office_address.city || ""}, ${b.office_address.state || ""
                    ...
                    <div className="flex flex-wrap items-center justify-between p-4 border-b border-gray-200 gap-4">
                        <div className="flex border-b border-gray-200">
                            <button
                                ...
                                className={`flex items-center gap-2 px-4 py-2 text-sm font-semibold transition-colors ${activeTab === "visitors"
                            ...
                            <button
                                ...
                                className={`flex items-center gap-2 px-4 py-2 text-sm font-semibold transition-colors ${activeTab === "brokers"
                                    ? "border-b-2 border-red-500 text-red-600"
                                    : "text-gray-500 hover:text-gray-800"
                                    }`}
                            >
                                    ...
                                    {visitorLogs.map((log) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4">
                                                <span
                                                    className={`px-3 py-1 text-xs font-semibold rounded-full inline-block ${log.visitStatus === "Success"
                                    ...
                                    {Array.isArray(assignedBrokers) &&
                                        ...
                                        assignedBrokers.map((brokers) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-4 text-gray-600">
                                                    <span
                                                        className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${brokers.is_active
                                                            ? "bg-green-100 text-green-700"
                                                            : "bg-red-100 text-red-700"
                                                            }`}
                                                    >
